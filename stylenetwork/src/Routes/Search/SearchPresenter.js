...
const SearchPresenter = ({searchResult, searchTerm, error, loading, controllSubmit, changeTerm}) => (
    <FormWrapper>
        <Form onSubmit={controllSubmit}>
            <Input placeholder="Search Movie Plz..." value={searchTerm} onChange={changeTerm} />
        </Form>
        {loading ? (
            <Loading />
        ) : (
